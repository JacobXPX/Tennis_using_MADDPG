...
class DDPGAgent:
    def __init__(self, obs_size, state_size, action_size, random_seed, 
                 lr_actor=LR_ACTOR, lr_critic=LR_CRITIC,weight_decay= WEIGHT_DECAY):
        """Initialize an Agent object.
        
        Params
        ======
            obs_size (int): dimension of each observation for agent
        ...
        self.critic_local = Critic(state_size, action_size*2, random_seed).to(device)
        self.critic_target = Critic(state_size, action_size*2, random_seed).to(device)
